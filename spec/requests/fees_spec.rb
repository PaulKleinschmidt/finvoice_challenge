...
RSpec.describe "/fees", type: :request do
  ...
  # FeesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get fees_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Fee" do
        expect {
          post fees_url,
               params: { fee: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Fee" do
        expect {
          post fees_url,
               params: { fee: invalid_attributes }, as: :json
        }.to change(Fee, :count).by(0)
      end

      it "renders a JSON response with errors for the new fee" do
        post fees_url,
             params: { fee: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested fee" do
        fee = Fee.create! valid_attributes
        patch fee_url(fee),
              params: { fee: new_attributes }, headers: valid_headers, as: :json
        fee.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested fee" do
      fee = Fee.create! valid_attributes
      expect {
        delete fee_url(fee), headers: valid_headers, as: :json
      }.to change(Fee, :count).by(-1)
    end
  end
end
